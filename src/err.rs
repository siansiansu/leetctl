...
pub enum Error {
    ...
    #[error(
        "Your leetcode cookies seems expired, \
         ...
         https://github.com/siansiansu/leetctl/blob/main/docs/cookies.md",
    ...
    #[error(
        ...
        "https://github.com/siansiansu/leetctl/".underline()
    )]
    PremiumError,
    #[error(transparent)]
    ...
    #[error(
        ...
        "https://github.com/siansiansu/leetctl/issues/new".underline()
    )]
    SetData {
        slug: String,
